...
const ForgotPasswordLog = ({ setUsuarios, onClose }) => {
  ...
  return (
    <>
      ...
      >
        <p className="m-0">
        ¡Hola! Si deseas cambiar tu contraseña, 
        debes seguir un par de pasos. 
        Primero, confirma que deseas hacer el cambio.
        Después de confirmar, se enviará a tu correo electrónico 
        una contraseña temporal, la cual deberás utilizar para 
        iniciar sesión nuevamente. Una vez que hayas iniciado sesión con la contraseña temporal, podrás actualizarla a la contraseña que desees.
        </p>
      </Dialog>
    </>
  );
